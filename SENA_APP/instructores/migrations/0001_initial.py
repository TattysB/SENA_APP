    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_educativo', models.CharField(choices=[('TEC', 'Técnico'), ('TEG', 'Tecnólogo'), ('PRE', 'Pregrado'), ('ESP', 'Especialización'), ('MAE', 'Maestría'), ('DOC', 'Doctorado')], default='MAE', max_length=3)),
