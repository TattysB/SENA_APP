    ...
    class Meta:
        ...
        widgets = {
            "codigo": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ej: PROG001"}
            ),
            "nombre": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Nombre del programa"}
            ),
            ...
            "duracion_horas": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "120"}
            ),
            ...
            "requisitos_ingreso": forms.Textarea(
